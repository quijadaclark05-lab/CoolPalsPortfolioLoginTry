...
{
    public partial class SelectedJerome : Form
    {
        ...
        public SelectedJerome()
        {
            InitializeComponent();
            this.KeyPreview = true;
            this.KeyDown += SelectedJerome_KeyDown;
        ...
        private void SelectedJerome_Load(object sender, EventArgs e)
        {
            GoFullscreen();
        }
        ...
        private void SelectedJerome_KeyDown(object sender, KeyEventArgs e)
        {
