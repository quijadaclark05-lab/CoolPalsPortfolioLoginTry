...
{
    public partial class SelectedRalph : Form
    {
        ...
        public SelectedRalph()
        {
            InitializeComponent();
            this.KeyPreview = true;
            this.KeyDown += SelectedRalph_KeyDown;
        ...
        private void SelectedRalph_Load(object sender, EventArgs e)
        {
            GoFullscreen();
        }
        ...
        private void Selected_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                // hide overlay when not near top and in fullscreen
        ...
        private void SelectedRalph_KeyDown(object sender, KeyEventArgs e)
        {
