...
{
    public partial class SelectedJared : Form
    {
        ...
        public SelectedJared()
        {
            InitializeComponent();
            this.KeyPreview = true;
            this.KeyDown += SelectedJared_KeyDown;
        ...
        private void SelectedJared_Load(object sender, EventArgs e)
        {
            GoFullscreen();
        }
        ...
        private void SelectedJared_KeyDown(object sender, KeyEventArgs e)
        {
